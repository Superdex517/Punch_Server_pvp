...
public class CharactorContollerOnePerson : MonoBehaviour
{
    //Urg that's ugly, maybe find a better way
    public static CharactorContollerOnePerson Instance { get; protected set; }
    ...
    void Start()
    {
        ...
        if (GetComponent<MyHero>())
        {
            ...
            MainCamera = CameraPosition.gameObject.AddComponent<Camera>();
            MainCamera.transform.SetParent(CameraPosition.transform, false);
